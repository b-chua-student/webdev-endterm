...
<div class="container-fluid py-5 px-4">
    <div class="row gx-5"> 
        ...
        <div class="col-lg-7">
            {{-- Flex container to put big image and 5 thumbs side-by-side --}}
        ...
        {{-- Max-width 771px and Padding-top added per prototype requirements --}}
        <div class="col-lg-5 d-flex flex-column pt-5" style="max-width: 771px;">
            
            <a href="#" class="text-decoration-none d-flex align-items-center gap-1 mb-5" style="color: #800000; font-size: 0.9rem;">
                <span style="font-size: 1.2rem; line-height: 0;">&larr;</span> Back to Products
            </a>
            
            <p class="mb-2" style="color: #7d0a0a91; font-size: 0.95rem;">Arwen</p>
            
            <h1 class="mb-5" style="color: #7d0a0a; font-weight: 300; font-size: 3rem;">Rapunzel</h1>
            
            <div class="py-3 px-4 mb-5" style="background-color: #f7f7f7; width: fit-content; min-width: 100%;">
                <h2 class="m-0" style="color: #7d0a0a; font-weight: 600;">₱99-199.99</h2>
            </div>
            ...
            <p class="mb-5" style="color: #7d0a0a; font-size: 0.85rem;">Stock Available: 30 pcs</p>
